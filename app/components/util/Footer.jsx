export default function Footer() {
  return (
    <>
      {/* Github Link */}
      <div className="grid place-content-center mb-6 h-[5vh]">
        <a
          target="_blank"
      ...
      <div className="grid grid-cols-6 place-items-center gap-2 md:mx-36 h-[10vh]">
        <h2 className="text-xs md:text-md text-center md:text-start w-full">
          Built with
        </h2>
        {/* Remix */}
